...
❌ However, for the Person page, no such mechanisms are available. From such a page, machines do not have a quick, machine-readable overview of all scholarly contributions of a researcher, even though the Biblio API does support such exports.

Navigating to a page such as https://biblio.ugent.be/person/0000-0001-8390-6171 should also provide for machines a link to a machine-readable version of these publications. E.g. a link to https://biblio.ugent.be/person/0000-0001-8390-6171/publication/export?format=json

TODO : How to discover such links?
:::
